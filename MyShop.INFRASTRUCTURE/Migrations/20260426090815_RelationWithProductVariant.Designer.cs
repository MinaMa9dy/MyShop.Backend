...
namespace MyShop.INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20260426090815_RelationWithProductVariant")]
    partial class RelationWithProductVariant
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyShop.CORE.Entities.ProductCoupon", b =>
                {
                    ...
                    b.HasKey("ProductVariantId", "CouponId");
            ...
            modelBuilder.Entity("MyShop.CORE.Entities.UserCoupon", b =>
                {
                    ...
                    b.HasOne("MyShop.CORE.Entities.Customer", "User")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
